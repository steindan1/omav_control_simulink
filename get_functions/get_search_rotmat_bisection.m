function R_s = get_search_rotmat_bisection(alpha,R_r,I_f_r)
params = parameters();
...
% get force vector in reference frame
r_f_r = R_r'*I_f_r;
...
mArrow3([0 0 0],r_f_r,'color','r')

% get angle between e_alpha and r_f_r
u = e_alpha;
v = r_f_r;
...
while delta > 0.01 && k < max_iter 
    ...
    omega_sq = B_pinv * [R_s'*r_f_r;zeros(3,1)];
    ...
    e_f = norm(B*omega_sq - [R_s'*r_f_r;zeros(3,1)]);
